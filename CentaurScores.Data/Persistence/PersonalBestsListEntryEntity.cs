...
namespace CentaurScores.Persistence
{
    ...
    public class PersonalBestsListEntryEntity
    {
        ...
        public PersonalBestListEntryModel ToModel(bool includeParticipant = true)
        {
        ...
        public void UpdateFromModel(CentaurScoresDbContext db, PersonalBestListEntryModel model)
        {
