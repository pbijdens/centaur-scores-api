...
public static class ModelExtensions
{
    public static ListConfigurationModel GetConfiguration(this ParticipantListEntity participantListEntity)
    {
        return string.IsNullOrWhiteSpace(participantListEntity.ConfigurationJSON)
            ? ListConfigurationModel.CentaurIndoorDefaults
            : System.Text.Json.JsonSerializer.Deserialize<ListConfigurationModel>(participantListEntity.ConfigurationJSON) ?? ListConfigurationModel.CentaurIndoorDefaults;
    }
}
